...
export class TestClient {
  ...
  async loadProto() {
    ...
    const clientV2ProtoPath = join(__dirname, '../../public/proto/v2/client.proto');
    ...
    // EncryptedMessage moved to client v2 proto
    this.clientV2Proto = await protobuf.load(clientV2ProtoPath);
    this.EncryptedMessage = this.clientV2Proto.lookupType('obscura.v2.EncryptedMessage');
  }
